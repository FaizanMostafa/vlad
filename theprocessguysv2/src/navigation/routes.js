...
const routes = {
  ...
  user: [
    ...
    },
    {
      exact: true,
      path: "/questionaire",
      component: QuestionaireMain,
      isProtected: true,
      redirect: "/login",
    },
    {
      exact: true,
      path: "/case-document-archive",
      component: CaseDocumentArchive,
      isProtected: true,
      redirect: "/login",
    },
    {
      exact: true,
      path: "/news-update-for-clients",
      component: NewsUpdateForClients,
      isProtected: true,
      redirect: "/login",
    },
    {
      exact: true,
      path: "/client-payment-credit-card",
      component: ClientPaymentCredit,
      isProtected: true,
      redirect: "/login",
    },
    {
    ...
    },
    {
      ...
      component: ClientPaymentOptions,
      isProtected: true,
      redirect: "/login",
    },
    {
    ...
    {
      exact: true,
      path: "/case-submission-success",
      component: CaseSubmissionSuccess,
      isProtected: true,
      redirect: "/login",
    },
    {
      exact: true,
      path: "/client-payment-debit-card",
      component: ClientPaymentDebit,
      isProtected: true,
      redirect: "/login",
    },
    {
      exact: true,
      path: "/client-payment-zelle",
      component: ClientPaymentZelle,
      isProtected: true,
      redirect: "/login",
    },
    {
      exact: true,
      path: "/client-payment-checks",
      component: ClientPaymentsChecks,
      isProtected: true,
      redirect: "/login",
    },
    {
