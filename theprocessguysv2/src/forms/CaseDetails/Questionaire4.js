  ...
  return (
    <>
      ...
      {Object.entries(serveesDetail).map(([serveeKey, servee]) => (
        <>
          <Form.Label style={{ fontWeight: "bold", fontSize: 22 }}>
            Servee{" "}
            {Object.entries(serveesDetail).length > 1 && Number(serveeKey) + 1}{" "}
            Details
          </Form.Label>
          <MDBRow md="12">
            <MDBCol md="12">
              <Form.Group id="name-of-individuals">
                <Form.Label>
                  Full Name or Title of who is Receiving Service*
                </Form.Label>
                <Form.Control
                  type="text"
            ...
            <MDBCol md="6">
              <Form.Group id="approx-age-of-individuals">
                <Form.Label>
                  Approximate age of servee, if DOB is unknown
                </Form.Label>
                <Form.Control
                  type="text"
                  value={servee.age}
          ...
          <MDBCol md="12" id="employment-of-individuals">
            <div id={`employment-of-individuals${serveeKey}`}>
              <Form.Label>Is the Servee Currently Employed?*</Form.Label>
              <br />
              ...
              <>
                ...
                <MDBCol md="12" id="main-address-for-service">
                      ...
                      Number(serviceDetailKey) + Number(serveeKey) > 0 && (
                        <MDBRow md="12">
                          <MDBCol md="12">
                            <Form.Group
                              className="mb-3"
                              controlId={`sameAddressCheckbox${serveeKey}${serviceDetailKey}`}
                            >
                              <Form.Check
                                checked={
                  ...
                  <MDBCol md="12">
                    <Form.Group id="require-stake-out-service">
                      <Form.Label>
                        ...
                        "Regular Service" after 4 attempts, [after 3 attempts in
                        California])*
                      </Form.Label>
                      <br />
                      <div style={{ display: "flex" }}>
                  ...
                  <MDBCol md="12">
                    <Form.Group id="require-stake-out-service">
                      <Form.Label>
                        ...
                        circumstances that the authorized individual refuses to
                        accept documents upon contact/sub-service)*
                      </Form.Label>
                      <br />
                      <div style={{ display: "flex" }}>
                        <Form.Check
                  ...
                  <MDBCol md="12">
                    <Form.Group id="require-stake-out-service">
                      <Form.Label>
                        May our Process Server post documents with a rubber band
                        on the door handle, once due diligence has been met?
                        Verify with Judge if permissible (varies by case)*
                      </Form.Label>
                      <br />
                      <div style={{ display: "flex" }}>
                        <Form.Check
