        ...
        Object.entries(vehiclesInformation).map(([key, vehicle])=>(
          <>
            ...
            <MDBRow md="12">
              <MDBCol md="6">
                <Form.Group id="vehicle-type-model-ownership">
                  <Form.Label>Vehicle Type/Model Ownership <i>(ie car, motorcycle, boat, RV)</i></Form.Label>
                  <Form.Control 
                    type="textarea"
            ...
            <MDBRow md="12">
              ...
              <MDBCol md="6">
                <Form.Group id="licence-plate-number-state">
                  <Form.Label>Licence Plate Number/State of Registration(s)</Form.Label>
                  <Form.Control
                    type="text"
                    disabled={isFormDisabled}
