    ...
    <>
      ...
      <MDBCol md="12" id="number-of-defendant-listed">
        <Form.Group
          ...
          id="number-of-defendant-listed"
        >
          <Form.Label>Number of Defendant(s) listed?</Form.Label>
          <br></br>
          <Form.Control
      ...
      <MDBCol md="12" id="number-of-attorney-representing-defendant">
        <Form.Group
          style={{ display: "flex", alignItems: "center" }}
          id="number-of-attorney-representing-defendant"
        >
          <Form.Label>
            Number of Attorney's Representing the Defendant?*
          </Form.Label>
          <br></br>
          <Form.Control
            as="select"
