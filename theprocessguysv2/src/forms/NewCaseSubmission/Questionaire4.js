    ...
    <>
      ...
      </MDBCol>
      {
        Object.entries(serveesDetail).map(([serveeKey, servee])=>(
          <>
            <MDBCol md="12">
              <label style={{fontWeight: "bold", fontSize: 22}}>Servee {Object.entries(serveesDetail).length>1 && Number(serveeKey)+1} Details</label>
              ...
              <MDBCol md="12" id="employment-of-individuals">
                <div id={`employment-of-individuals${serveeKey}`}>
                  ...
                  /><label className="ml-2" for={`employmentOfIndividualsY${serveeKey}`}>Yes</label>
                  <input
                  ...
                  /><label className="ml-2" for={`employmentOfIndividualsN${serveeKey}`}>No</label>
                  <input
                    className="ml-4" type="radio"
                  ...
                  /><label className="ml-2" for={`employmentOfIndividualsU${serveeKey}`}>Unknown</label>
                  <br/>
                </div>
              </MDBCol>
              {
                Object.entries(servee.serviceDetails).map(([serviceDetailKey, serviceDetail])=>(
                  <>
                    <MDBCol md="12">
                      <label style={{fontWeight: "bold"}}>{Number(serviceDetailKey)===0 && "Main "}Address {(Number(serviceDetailKey)!==0 && Object.keys(servee.serviceDetails).length>1) && Number(serviceDetailKey)+1} for Service</label>
                      ...
                      <MDBCol md="12">
                        <div id="require-first-24-hour-service">
                          ...
                          /><label className="ml-2" for={`requireFirst24HourServiceY${serveeKey}${serviceDetailKey}`}>Yes</label>
                          <input
                            className="ml-4" type="radio"
                          ...
                          /><label className="ml-2" for={`requireFirst24HourServiceN${serveeKey}${serviceDetailKey}`}>No</label>
                          <br/>
                        </div>
                      </MDBCol>
                      <MDBCol md="12">
                        <div id="require-first-24-hour-service">
                          ...
                          /><label className="ml-2" for={`requireRushServiceY${serveeKey}${serviceDetailKey}`}>Yes</label>
                          <input
                            className="ml-4" type="radio"
                          ...
                          /><label className="ml-2" for={`requireRushServiceN${serveeKey}${serviceDetailKey}`}>No</label>
                          <br/>
                        </div>
                      </MDBCol>
                      <MDBCol md="12">
                        <div id="require-first-24-hour-service">
                          ...
                          /><label className="ml-2" for={`requireStakeOutServiceY${serveeKey}${serviceDetailKey}`}>Yes</label>
                          <input
                            className="ml-4" type="radio"
                          ...
                          /><label className="ml-2" for={`requireStakeOutServiceN${serveeKey}${serviceDetailKey}`}>No</label>
                          <br/>
                        </div>
                      </MDBCol>
                      {/* 5th question pending */}
                      <MDBCol md="12">
                        <label>Please provide a closing date for when all service attempts must cease. (Regular service time frame should be 2-5 weeks, unless otherwise specified)*</label><br/>
                        <MDBInput
                          type="text"
                          className="text-white"
                      ...
                      <MDBCol md="12">
                        <div id="require-first-24-hour-service">
                          <label>Is a "Drop Serve/Force Serve" allowed? (Only once Residency/Employment is confirmed. Under the circumstances that the authorized individual refuses to accept documents upon contact/sub-service)*</label><br />
                          <input
                            className="ml-2" type="radio"
                          ...
                          /><label className="ml-2" for={`shouldDropServeY${serveeKey}${serviceDetailKey}`}>Yes</label>
                          <input
                            className="ml-4" type="radio"
                          ...
                          /><label className="ml-2" for={`shouldDropServeN${serveeKey}${serviceDetailKey}`}>No</label>
                          <br/>
                        </div>
                      </MDBCol>
                      <MDBCol md="12">
                        <div id="require-first-24-hour-service">
                          <label>May the Process Server leave a door tag on the handle, or business card with their title and contact information?*</label><br />
                          <input
                            className="ml-2" type="radio"
                          ...
                          /><label className="ml-2" for={`shouldLeaveDoorTagY${serveeKey}${serviceDetailKey}`}>Yes</label>
                          <input
                            className="ml-4" type="radio"
                          ...
                          /><label className="ml-2" for={`shouldLeaveDoorTagN${serveeKey}${serviceDetailKey}`}>No</label>
                          <br/>
                        </div>
                      </MDBCol>
                      <MDBCol md="12">
                        <div id="require-first-24-hour-service">
                          <label>May our Process Server post documents with a rubber band on the door handle, once due diligence has been met? Verify with Judge if permissible (varies by case)*</label><br />
                          <input
                            className="ml-2" type="radio"
                          ...
                          /><label className="ml-2" for={`shouldPostDocsWithBandY${serveeKey}${serviceDetailKey}`}>Yes</label>
                          <input
                            className="ml-4" type="radio"
                          ...
                          /><label className="ml-2" for={`shouldPostDocsWithBandN${serveeKey}${serviceDetailKey}`}>No</label>
                          <br/>
                        </div>
                      </MDBCol>
                      <MDBCol md="12">
                        <div id="require-first-24-hour-service">
                          ...
                          <input
                            className="ml-2" type="radio"
                            onClick={()=>setServeesDetail({...serveesDetail, [serveeKey]: {...servee, serviceDetails: {...servee.serviceDetails, [serviceDetailKey]: {...serviceDetail, isThereAnAgentOfService: true}}}})}
                            id={`agentOfServiceY${serveeKey}${serviceDetailKey}`} name={`agentOfService${serveeKey}${serviceDetailKey}`} checked={serviceDetail.isThereAnAgentOfService===true}
                          /><label className="ml-2" for={`agentOfServiceY${serveeKey}${serviceDetailKey}`}>Yes</label>
                          <input
                            className="ml-4" type="radio"
                            onClick={()=>setServeesDetail({...serveesDetail, [serveeKey]: {...servee, serviceDetails: {...servee.serviceDetails, [serviceDetailKey]: {...serviceDetail, isThereAnAgentOfService: false}}}})}
                            id={`agentOfServiceN${serveeKey}${serviceDetailKey}`} name={`agentOfService${serveeKey}${serviceDetailKey}`} checked={serviceDetail.isThereAnAgentOfService===false}
                          /><label className="ml-2" for={`agentOfServiceN${serveeKey}${serviceDetailKey}`}>No</label>
                          <br/>
                        </div>
                      </MDBCol>
                      {
                          ...
                          &&
                            <>
                              <MDBCol md="12" id="if-yes-list-full-name">
                                <label>Full Name to Agent of Service</label><br/>
                                {
                      ...
                      {
                        Number(serviceDetailKey)===Object.keys(servee.serviceDetails).length-1
                          &&
                            <MDBCol>
